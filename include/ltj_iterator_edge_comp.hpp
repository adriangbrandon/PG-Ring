...
#ifndef RING_LTJ_ITERATOR_EDGE_COMP_HPP
#define RING_LTJ_ITERATOR_EDGE_COMP_HPP
...
namespace ring {
    ...
    class ltj_iterator_edge_comp : public ltj_iterator_base<var_t, cons_t> {
    public:
    ...
    public:
        ...
        ltj_iterator_edge_comp() = default;

        ltj_iterator_edge_comp(const expr_type *expr, ring_type *ring) {
            m_ptr_ring = ring;
            m_expr = expr;
            m_is_empty = false;
            m_fixed_values = {0, 0};
        ...
        //! Copy constructor
        ltj_iterator_edge_comp(const ltj_iterator_edge_comp &o) {
            copy(o);
        }

        //! Move constructor
        ltj_iterator_edge_comp(ltj_iterator_edge_comp &&o) noexcept {
            *this = std::move(o);
        }

        //! Copy Operator=
        ltj_iterator_edge_comp &operator=(const ltj_iterator_edge_comp &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        //! Move Operator=
        ltj_iterator_edge_comp &operator=(ltj_iterator_edge_comp &&o) noexcept {
            if (this != &o) {
        ...
        void swap(ltj_iterator_edge_comp &o) noexcept {
...
#endif //RING_LTJ_ITERATOR_EDGE_COMP_HPP
