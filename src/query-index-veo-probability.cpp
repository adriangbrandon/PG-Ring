    ...
    if(result)
    {
        ...
        for (string& query_string : dummy_queries) {
            ...
            typedef ring::ltj_algorithm_pg<iterator_type,
                    ring::veo::veo_adaptive_pg<iterator_type, ring::util::trait_probability,
                    ring::util::op_product>> algorithm_type;
#else
            typedef ring::ltj_algorithm<iterator_type,
                    ring::veo::veo_simple<iterator_type, ring::util::trait_probability,
                    ring::util::op_product>> algorithm_type;
#endif
...
int main(int argc, char* argv[])
{
    ...
    if(type == "ring"){
        query<ring::ring<>>(index, queries, limit);
    }else if (type == "c-ring"){
        query<ring::c_ring>(index, queries, limit);
    }else if (type == "ring-sel"){
        query<ring::ring_sel>(index, queries, limit);
    }else{
