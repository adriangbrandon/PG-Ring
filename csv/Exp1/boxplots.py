...
names = ['Ring-large', 'Ring-small', 'URing-large', 'URing-small', 'RDFCSA-large', 'RDFCSA-small', 'CompactLTJ-fix']
bpt = [12, 12.5, 7.30, 7.8, 22.2, 22.7, 14.61, 15.11, 23.2, 23.7, 15.8, 16.3, 41.8]
...
legend_order = ['Ring-s', 'Ring-l', 'URing-s', 'URing-l', 'RDFCSA-s', 'RDFCSA-l', 'VRing-s', 'VRing-l', 'VURing-s', 'VURing-l', 'CompactLTJ']
...
fig.legend(h, l, ncol=6, fontsize=14, loc='upper center', bbox_to_anchor=[0.5, 1.06])
fig.tight_layout()
#plt.show()



fig.savefig('boxplots-space-time-vertical-a.pdf', bbox_inches ="tight")
