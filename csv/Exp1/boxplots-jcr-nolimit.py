...
#df_data['IRing-large'] = df_iring['time'].div( 1000000000.0)
#df_data['IRing-small'] = df_ciring['time'].div( 1000000000.0)
...
#df_data['IURing-large'] = df_iuring['time'].div( 1000000000.0)
#df_data['IURing-small'] = df_ciuring['time'].div( 1000000000.0)
...
#df_data['CompactLTJ'] = df_cltj['time'].div( 1000000000.0)
#df_data['CompactLTJ-fix'] = df_cltj_fix['time'].div( 1000000000.0)
...
df_iring = pd.read_csv("adaptive/" + l + "type3.iring.time.csv" ,
					  header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])
df_ciring = pd.read_csv("adaptive/" + l + "type3.small-iring.time.csv",
					   header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])
df_iuring = pd.read_csv("adaptive/" + l + "type3.iuring.time.csv" ,
					  header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])
df_ciuring = pd.read_csv("adaptive/" + l + "type3.small-iuring.time.csv",
					   header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])

df_iring_fix = pd.read_csv("fixed/" + l + "type3.iring.fixed.time.csv" ,
					  header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])
df_ciring_fix = pd.read_csv("fixed/" + l + "type3.small-iring.fixed.time.csv",
					   header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])
df_iuring_fix = pd.read_csv("fixed/" + l + "type3.iuring.fixed.time.csv" ,
					  header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])
df_ciuring_fix = pd.read_csv("fixed/" + l + "type3.small-iuring.fixed.time.csv",
					   header=None, delimiter=';', names=['id', 'res', 'time', 'utime'])
...
df_data['Ring-small-fix'] = df_cring_fix['time'].div( 1000000000.0)
df_data['IRing-large'] = df_iring['time'].div( 1000000000.0)
df_data['IRing-large-fix'] = df_iring_fix['time'].div( 1000000000.0)
df_data['IRing-small'] = df_ciring['time'].div( 1000000000.0)
df_data['IRing-small-fix'] = df_ciring_fix['time'].div( 1000000000.0)
df_data['URing-large'] = df_uring['time'].div( 1000000000.0)
df_data['URing-large-fix'] = df_uring_fix['time'].div( 1000000000.0)
df_data['URing-small'] = df_curing['time'].div( 1000000000.0)
df_data['URing-small-fix'] = df_curing_fix['time'].div( 1000000000.0)
df_data['IURing-large'] = df_iuring['time'].div( 1000000000.0)
df_data['IURing-large-fix'] = df_iuring_fix['time'].div( 1000000000.0)
df_data['IURing-small'] = df_ciuring['time'].div( 1000000000.0)
df_data['IURing-small-fix'] = df_ciuring_fix['time'].div( 1000000000.0)
df_data['VRing-large'] = df_ringm['time'].div( 1000000000.0)
df_data['VRing-large-fix'] = df_ring_fixm['time'].div( 1000000000.0)
df_data['VRing-small'] = df_cringm['time'].div( 1000000000.0)
df_data['VRing-small-fix'] = df_cring_fixm['time'].div( 1000000000.0)
df_data['VURing-large'] = df_uringm['time'].div( 1000000000.0)
df_data['VURing-large-fix'] = df_uring_fixm['time'].div( 1000000000.0)
df_data['VURing-small'] = df_curingm['time'].div( 1000000000.0)
df_data['VURing-small-fix'] = df_curing_fixm['time'].div( 1000000000.0)
df_data['RDFCSA-large'] = df_rdfcsa['time'].div( 1000000000.0)
df_data['RDFCSA-large-fix'] = df_rdfcsa_fix['time'].div( 1000000000.0)
df_data['RDFCSA-small'] = df_crdfcsa['time'].div( 1000000000.0)
df_data['RDFCSA-small-fix'] = df_crdfcsa_fix['time'].div( 1000000000.0)
#df_data['CompactLTJ'] = df_cltj['time'].div( 1000000000.0)
#df_data['CompactLTJ-fix'] = df_cltj_fix['time'].div( 1000000000.0)
...
legend_order = ['Ring-s', 'Ring-l', 'IRing-s', 'IRing-l', 'URing-s', 'URing-l', 'IURing-s', 'IURing-l', 'RDFCSA-s', 'RDFCSA-l', 'VRing-s',
 'VRing-l', 'VURing-s', 'VURing-l']
...
ax1.legend(h,l, fontsize=12)
fig.tight_layout()
#plt.show()



fig.savefig('boxplots-jcr-nolimit.pdf', bbox_inches ="tight")
