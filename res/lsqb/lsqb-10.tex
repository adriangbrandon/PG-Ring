...
\begin{tikzpicture}[font=\large]
    ...
    \node[anchor=west, font=\normalsize, xshift=2pt] at (axis cs:13.16,4.97) {MillDB};
    \node[anchor=west, font=\normalsize, xshift=2pt] at (axis cs:9.47,743.91) {Neo4j};
    \node[anchor=west, font=\normalsize, xshift=2pt] at (axis cs:2.43,63.11) {PG-Ring};
    \node[anchor=east, font=\normalsize, xshift=38pt] at (axis cs:4.35,1676.13) {Umbra};
    \node[anchor=west, font=\normalsize, xshift=-2pt, yshift=8pt] at (axis cs:1.56,2048.76) {DuckDB};
    \node[anchor=west, font=\normalsize, xshift=2pt] at (axis cs:4.98,22282.52) {Kùzu};
    \node[anchor=west, font=\normalsize, xshift=2pt] at (axis cs:55.85,11011.47) {Memgraph};
